...
"""
    ...
    service_descriptor: Optional[ServiceDescriptor] = None

    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "ServiceRef":
        ...
        return cls(
            ...
            service_descriptor=ServiceDescriptor.from_dict(data.get("serviceDescriptor")) if isinstance(data.get("serviceDescriptor"), dict) else data.get("serviceDescriptor"),
        )
