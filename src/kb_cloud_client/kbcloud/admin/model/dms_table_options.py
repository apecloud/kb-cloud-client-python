...
class DmsTableOptions:
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "DmsTableOptions":
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.charset is not None:
            _v = self.charset
            result["charset"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
        if self.collation is not None:
            _v = self.collation
            result["collation"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
