...
class LicenseApi:
    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._get_license_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/license",
                "http_method": "GET",
        ...
        self._update_license_endpoint = _Endpoint(
            settings={
                "response_type": License,
                "endpoint_path": "/admin/v1/license",
                "http_method": "POST",
    ...
    def update_license(
        ...
        Update license
        :type body: LicenseRequest
        :rtype: License
        """
        kwargs: Dict[str, Any] = {}
        kwargs["body"] = body
        return self._update_license_endpoint.call_with_http_info(**kwargs)
