    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._create_redis_account_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/data/redis/organizations/{orgName}/clusters/{clusterName}/accounts",
                "http_method": "POST",
        ...
        self._delete_redis_account_endpoint = _Endpoint(
            settings={
                "response_type": ClusterTask,
                "endpoint_path": "/admin/v1/data/redis/organizations/{orgName}/clusters/{clusterName}/accounts/{accountName}",
                "http_method": "DELETE",
