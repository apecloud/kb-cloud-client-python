    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._chat_biv2_sse_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/ai/chatbi/v2",
                "http_method": "POST",
        ...
        self._chat_v2_sse_endpoint = _Endpoint(
            settings={
                "response_type": ChatResponse,
                "endpoint_path": "/api/v1/ai/chatops/v2",
                "http_method": "POST",
        ...
        self._delete_conversation_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/ai/conversations/{conversationId}",
                "http_method": "DELETE",
        ...
        self._get_conversation_messages_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/ai/conversations/{conversationId}/messages",
                "http_method": "GET",
        ...
        self._list_conversations_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/ai/conversations",
                "http_method": "GET",
