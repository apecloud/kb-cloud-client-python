    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._get_restore_log_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/restore/{restoreId}/logs",
                "http_method": "GET",
        ...
        self._delete_restore_object_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/restore",
                "http_method": "DELETE",
        ...
        self._get_restore_time_range_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/organizations/{orgName}/clustersWithDelete/restoreTimeRange",
                "http_method": "GET",
        ...
        self._list_restores_endpoint = _Endpoint(
            settings={
                "response_type": RestoreList,
                "endpoint_path": "/admin/v1/restoreTasks",
                "http_method": "GET",
        ...
        self._restore_cluster_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/organizations/{orgName}/restore",
                "http_method": "POST",
