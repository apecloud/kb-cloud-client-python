...
class DataChannelListEndpoint:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "DataChannelListEndpoint":
        ...
        return cls(
            ...
            custom=CustomEndpoint.from_dict(data.get("custom")) if isinstance(data.get("custom"), dict) else data.get("custom"),
