...
@dataclass
class ClusterBackupMethod:
    """the backup method for cluster"""
    # Required fields
    # Optional fields
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "ClusterBackupMethod":
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.continuous is not None:
            _v = self.continuous
            result["continuous"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
        return result
