...
@dataclass
class OrgResourceQuotaAndUsage:
    """org resource quota"""
    # Required fields
    cpu: float
    memory: float
    ...
    usage: OrgResourceQuota
    # Optional fields

    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "OrgResourceQuotaAndUsage":
        ...
        return cls(
            ...
            usage=OrgResourceQuota.from_dict(data.get("usage")) if isinstance(data.get("usage"), dict) else data.get("usage"),
        )
