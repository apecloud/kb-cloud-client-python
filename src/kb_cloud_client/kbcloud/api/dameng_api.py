    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._create_tablespace_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/data/damengdb/organizations/{orgName}/clusters/{clusterName}/tablespaces",
                "http_method": "POST",
        ...
        self._delete_tablespace_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/data/damengdb/organizations/{orgName}/clusters/{clusterName}/tablespaces/{tablespaceName}",
                "http_method": "DELETE",
