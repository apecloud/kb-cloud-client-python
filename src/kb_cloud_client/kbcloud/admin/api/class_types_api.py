...
class ClasstypesApi:
    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._create_class_type_endpoint = _Endpoint(
            settings={
                "response_type": ClassType,
                "endpoint_path": "/admin/v1/classTypes",
                "http_method": "POST",
                "operation_id": "create_class_type",
            },
            params_map={
                "body": {
                    "location": "body",
        ...
        self._delete_class_type_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/admin/v1/classTypes/{id}",
                "http_method": "DELETE",
                "operation_id": "delete_class_type",
            },
            params_map={
                "id_": {
                    "required": True,
        ...
        self._update_class_type_endpoint = _Endpoint(
            settings={
                "response_type": ClassType,
                "endpoint_path": "/admin/v1/classTypes/{id}",
                "http_method": "PATCH",
                "operation_id": "update_class_type",
            },
            params_map={
                "id_": {
                    "required": True,
    ...
    def create_class_type(
        self,
        *,
        body: Union[CreateClassType, UnsetType] = unset,
    ) -> ClassType:
        """Create a new class type.
        :type body: CreateClassType, optional
        :rtype: ClassType
        """
        kwargs: Dict[str, Any] = {}
        if body is not unset:
            kwargs["body"] = body
        return self._create_class_type_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_class_type(
        ...
        kwargs: Dict[str, Any] = {}
        kwargs["id_"] = id_
        return self._delete_class_type_endpoint.call_with_http_info(**kwargs)
    ...
    def update_class_type(
        ...
        *,
        ...
        if body is not unset:
            kwargs["body"] = body
        return self._update_class_type_endpoint.call_with_http_info(**kwargs)
