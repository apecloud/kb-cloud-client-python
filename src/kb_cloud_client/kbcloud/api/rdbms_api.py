    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._generate_demo_data_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/data/{engineName}/organizations/{orgName}/clusters/{clusterName}/demo",
                "http_method": "POST",
        ...
        self._get_database_options_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/data/{engineName}/organizations/{orgName}/clusters/{clusterName}/dboptions",
                "http_method": "GET",
