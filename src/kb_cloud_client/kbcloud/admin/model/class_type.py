...
class ClassType:
    ...
    display_name: Optional[LocalizedDescription] = None
    created_at: Optional[datetime] = None

    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "ClassType":
        ...
        return cls(
            ...
            display_name=LocalizedDescription.from_dict(data.get("displayName")) if isinstance(data.get("displayName"), dict) else data.get("displayName"),
