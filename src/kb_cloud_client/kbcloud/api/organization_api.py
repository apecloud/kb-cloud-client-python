...
class OrganizationApi:
    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._delete_org_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}",
                "http_method": "DELETE",
        ...
        self._freeze_member_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/api/v1/organizations/{orgName}/members/{memberId}/freeze",
                "http_method": "POST",
        ...
        self._list_org_endpoint = _Endpoint(
            settings={
                "response_type": UserOrgList,
                "endpoint_path": "/api/v1/organizations",
                "http_method": "GET",
                "operation_id": "list_org",
            },
            params_map={
                "page_token": {
                    "location": "query",
        ...
        self._unfreeze_member_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/api/v1/organizations/{orgName}/members/{memberId}/unfreeze",
                "http_method": "POST",
    ...
    def list_org(
        ...
        *,
        ...
        List organizations of current user
        :param page_token: The pagination token in the List request
        :type page_token: str, optional
        :param page_size: The pagination size in the List request.
        ...
        return self._list_org_endpoint.call_with_http_info(**kwargs)
