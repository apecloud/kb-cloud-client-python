    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._create_tag_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/tags",
                "http_method": "POST",
        ...
        self._delete_tag_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/tags/{tagId}",
                "http_method": "DELETE",
        ...
        self._get_tags_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/clusterTags",
                "http_method": "GET",
