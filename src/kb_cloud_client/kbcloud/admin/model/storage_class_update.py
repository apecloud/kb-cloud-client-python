...
@dataclass
class StorageClassUpdate:
    """StorageClassUpdate provides the fields for updating a specific storage class."""
    # Required fields
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "StorageClassUpdate":
