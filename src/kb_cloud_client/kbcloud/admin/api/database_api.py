    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._create_database_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/data/{engineName}/organizations/{orgName}/clusters/{clusterName}/databases",
                "http_method": "POST",
        ...
        self._create_database_old_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/databases",
                "http_method": "POST",
        ...
        self._delete_database_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/admin/v1/data/{engineName}/organizations/{orgName}/clusters/{clusterName}/databases/{databaseName}",
                "http_method": "DELETE",
        ...
        self._delete_database_old_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/databases/{databaseName}",
                "http_method": "DELETE",
