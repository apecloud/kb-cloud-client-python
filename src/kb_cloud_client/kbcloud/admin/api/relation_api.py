    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._create_relation_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/relations",
                "http_method": "POST",
        ...
        self._delete_relation_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/relation/{target}",
                "http_method": "DELETE",
        ...
        self._list_available_clusters_for_relation_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/organizations/{orgName}/cluster/{clusterName}/available-relations",
                "http_method": "GET",
