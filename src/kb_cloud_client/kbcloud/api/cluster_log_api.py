    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._query_audit_logs_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/clusters/{clusterName}/logs/audit",
                "http_method": "GET",
        ...
        self._query_error_logs_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/clusters/{clusterName}/logs/error",
                "http_method": "GET",
        ...
        self._query_pod_logs_endpoint = _Endpoint(
            settings={
                "response_type": ClusterRawLogResponse,
                "endpoint_path": "/api/v1/organizations/{orgName}/clusters/{clusterName}/logs/pod",
                "http_method": "GET",
        ...
        self._query_running_logs_endpoint = _Endpoint(
            settings={
                "response_type": ClusterRawLogResponse,
                "endpoint_path": "/api/v1/organizations/{orgName}/clusters/{clusterName}/logs/running",
                "http_method": "GET",
        ...
        self._query_slow_logs_endpoint = _Endpoint(
            settings={
                "response_type": ClusterExecutionLog,
                "endpoint_path": "/api/v1/organizations/{orgName}/clusters/{clusterName}/logs/slow",
                "http_method": "GET",
