...
@dataclass
class RestoreStatusConditionsItem:
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "RestoreStatusConditionsItem":
        ...
        return cls(
            ...
            last_transition_time=_parse_datetime(data.get("lastTransitionTime")),
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.observed_generation is not None:
            _v = self.observed_generation
            result["observedGeneration"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
        if self.last_transition_time is not None:
            _v = self.last_transition_time
            result["lastTransitionTime"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
