    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._delete_recycle_bin_cluster_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/recycleBin/clusters/{clusterName}",
                "http_method": "DELETE",
        ...
        self._list_recycle_bin_cluster_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/recycleBin/clusters",
                "http_method": "GET",
        ...
        self._restore_recycle_bin_cluster_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/recycleBin/clusters/{clusterName}/restore",
                "http_method": "POST",
