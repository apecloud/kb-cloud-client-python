...
@dataclass
class ParameterList:
    """A list of cluster parameter"""
    # Required fields
    major_version: str
    engine: str
    component: str
    # Optional fields
    items: Optional[List[ParameterItem]] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ParameterList":
        ...
        return cls(
            ...
            items=[ParameterItem.from_dict(i) if isinstance(i, dict) else i for i in data.get("items")] if data.get("items") is not None else None,
        )
