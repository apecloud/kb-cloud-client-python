    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._create_account_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/data/{engineName}/organizations/{orgName}/clusters/{clusterName}/accounts",
                "http_method": "POST",
        ...
        self._create_account_old_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/accounts",
                "http_method": "POST",
        ...
        self._create_mongo_db_account_endpoint = _Endpoint(
            settings={
                "response_type": Account,
                "endpoint_path": "/admin/v1/data/mongodb/organizations/{orgName}/clusters/{clusterName}/accounts",
                "http_method": "POST",
        ...
        self._delete_account_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/admin/v1/data/{engineName}/organizations/{orgName}/clusters/{clusterName}/accounts/{accountName}",
                "http_method": "DELETE",
        ...
        self._delete_account_old_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/accounts/{accountName}",
                "http_method": "DELETE",
        ...
        self._delete_mongo_db_account_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/admin/v1/data/mongodb/organizations/{orgName}/clusters/{clusterName}/accounts/{accountName}",
                "http_method": "DELETE",
        ...
        self._delete_mssql_account_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/admin/v1/data/mssql/organizations/{orgName}/clusters/{clusterName}/accounts",
                "http_method": "DELETE",
        ...
        self._get_root_account_password_endpoint = _Endpoint(
            settings={
                "response_type": str,
                "endpoint_path": "/admin/v1/data/{engineName}/organizations/{orgName}/clusters/{clusterName}/root-password",
                "http_method": "GET",
        ...
        self._update_account_privileges_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/admin/v1/data/{engineName}/organizations/{orgName}/clusters/{clusterName}/accounts/{accountName}/privileges",
                "http_method": "PATCH",
        ...
        self._update_account_privileges_old_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/accounts/privileges/{accountName}",
                "http_method": "PATCH",
