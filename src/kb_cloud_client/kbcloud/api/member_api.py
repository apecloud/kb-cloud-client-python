...
class MemberApi:
    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._add_org_member_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/members",
                "http_method": "POST",
        ...
        self._delete_org_member_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/members/{memberId}",
                "http_method": "DELETE",
        ...
        self._list_org_member_permission_endpoint = _Endpoint(
            settings={
                "response_type": PermissionList,
                "endpoint_path": "/api/v1/organizations/{orgName}/permissions",
                "http_method": "GET",
                "operation_id": "list_org_member_permission",
            },
            params_map={
                "org_name": {
                    "required": True,
    ...
    def list_org_member_permission(
        self,
        org_name: str,
    ) -> PermissionList:
        ...
        kwargs: Dict[str, Any] = {}
        kwargs["org_name"] = org_name
        return self._list_org_member_permission_endpoint.call_with_http_info(**kwargs)
