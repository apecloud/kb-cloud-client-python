    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._cancel_ops_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/opsrequests/{opsName}/cancel",
                "http_method": "POST",
        ...
        self._cluster_volume_expand_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/volume-expand",
                "http_method": "POST",
        ...
        self._custom_ops_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/custom-ops",
                "http_method": "POST",
        ...
        self._expose_cluster_endpoint = _Endpoint(
            settings={
                "response_type": OpsRequestName,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/expose",
                "http_method": "POST",
        ...
        self._horizontal_scale_cluster_endpoint = _Endpoint(
            settings={
                "response_type": OpsRequestName,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/hscale",
                "http_method": "POST",
        ...
        self._list_available_nodes_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/rebuildInstance/availableNodes",
                "http_method": "GET",
        ...
        self._promote_cluster_endpoint = _Endpoint(
            settings={
                "response_type": OpsRequestName,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/promote",
                "http_method": "POST",
        ...
        self._rebuild_instance_endpoint = _Endpoint(
            settings={
                "response_type": OpsRequestName,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/rebuildInstance",
                "http_method": "POST",
        ...
        self._reconfigure_cluster_endpoint = _Endpoint(
            settings={
                "response_type": OpsRequestName,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/reconfigure",
                "http_method": "POST",
        ...
        self._restart_cluster_endpoint = _Endpoint(
            settings={
                "response_type": OpsRequestName,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/restart",
                "http_method": "POST",
        ...
        self._specify_cluster_io_quotas_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/volumes/io-quotas",
                "http_method": "POST",
        ...
        self._start_cluster_endpoint = _Endpoint(
            settings={
                "response_type": OpsRequestName,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/start",
                "http_method": "POST",
        ...
        self._stop_cluster_endpoint = _Endpoint(
            settings={
                "response_type": OpsRequestName,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/stop",
                "http_method": "POST",
        ...
        self._update_cluster_license_endpoint = _Endpoint(
            settings={
                "response_type": OpsRequestName,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/updateLicense",
                "http_method": "POST",
        ...
        self._upgrade_cluster_endpoint = _Endpoint(
            settings={
                "response_type": OpsRequestName,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/upgrade",
                "http_method": "POST",
        ...
        self._vertical_scale_cluster_endpoint = _Endpoint(
            settings={
                "response_type": OpsRequestName,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/vscale",
                "http_method": "POST",
