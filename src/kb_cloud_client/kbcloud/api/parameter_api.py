    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._list_parameter_props_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/clusters/{clusterName}/parameters",
                "http_method": "GET",
        ...
        self._list_parameters_history_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/clusters/{clusterName}/parameterHistories",
                "http_method": "GET",
