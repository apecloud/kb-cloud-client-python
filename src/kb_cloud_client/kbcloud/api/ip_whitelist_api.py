    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._create_ip_whitelist_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/clusters/{clusterName}/ipWhitelist",
                "http_method": "POST",
        ...
        self._delete_ip_white_list_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/clusters/{clusterName}/ipWhitelist/{ipWhitelistId}",
                "http_method": "DELETE",
