...
class EventApi:
    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._get_event_endpoint = _Endpoint(
            settings={
                "response_type": Event,
                "endpoint_path": "/admin/v1/events/{eventID}",
                "http_method": "GET",
        ...
        self._get_event_filter_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/eventfilter/{filterType}",
                "http_method": "GET",
        ...
        self._list_org_events_endpoint = _Endpoint(
            settings={
                "response_type": EventList,
                "endpoint_path": "/admin/v1/organizations/{orgName}/events",
                "http_method": "GET",
    ...
    def get_event_filter(
        ...
        *,
        ...
        Query available filters for event listing
        :param filter_type: The event filter field you want to obtain.
        :type filter_type: EventFilterType
        :param source: The event filter you want to query from a certain source.
        :type source: str
    ...
    def list_events(
        ...
        *,
        ...
        :param custom_query: Advanced query conditions, supporting all types of filterType. Such as "orgID:111 orgID:222 operatorID:333"
