    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._batch_add_role_permissions_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/roles/{roleName}/permissions/batch",
                "http_method": "POST",
        ...
        self._create_role_endpoint = _Endpoint(
            settings={
                "response_type": Role,
                "endpoint_path": "/api/v1/organizations/{orgName}/roles",
                "http_method": "POST",
        ...
        self._delete_role_by_name_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/api/v1/organizations/{orgName}/roles/{roleName}",
                "http_method": "DELETE",
        ...
        self._list_permissions_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/permissions",
                "http_method": "GET",
        ...
        self._list_role_permissions_endpoint = _Endpoint(
            settings={
                "response_type": PermissionList,
                "endpoint_path": "/api/v1/organizations/{orgName}/roles/{roleName}/permissions",
                "http_method": "GET",
