...
class FeatureApi:
    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._list_feature_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/features",
                "http_method": "GET",
        ...
        self._list_feature_group_endpoint = _Endpoint(
            settings={
                "response_type": List[str],
                "endpoint_path": "/admin/v1/featureGroups",
                "http_method": "GET",
                "operation_id": "list_feature_group",
            },
            params_map={
            },
            headers_map={
        ...
        self._read_feature_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/features/{featureName}",
                "http_method": "GET",
    ...
    def list_feature_group(
        ...
        """
        kwargs: Dict[str, Any] = {}
        return self._list_feature_group_endpoint.call_with_http_info(**kwargs)
