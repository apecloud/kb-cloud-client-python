...
class NodeResourceStats:
    ...
    name: str
    # Optional fields
    filesystem_stats: Optional[ResourceStats] = None

    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "NodeResourceStats":
        ...
        return cls(
            ...
            filesystem_stats=ResourceStats.from_dict(data.get("filesystemStats")) if isinstance(data.get("filesystemStats"), dict) else data.get("filesystemStats"),
            name=data.get("name"),
        )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.filesystem_stats is not None:
            _v = self.filesystem_stats
            result["filesystemStats"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
