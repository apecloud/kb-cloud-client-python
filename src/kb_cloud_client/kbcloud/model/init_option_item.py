...
@dataclass
class InitOptionItem:
    """InitOptionItem is the information of init option"""
    # Required fields
    # Optional fields
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "InitOptionItem":
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.init_params is not None:
            _v = self.init_params
            result["initParams"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
