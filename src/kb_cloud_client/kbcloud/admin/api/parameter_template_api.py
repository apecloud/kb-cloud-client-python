...
class ParametertemplateApi:
    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._create_parameter_template_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/parameterTemplates",
                "http_method": "POST",
        ...
        self._delete_parameter_template_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/parameterTemplate/{parameterTemplateName}",
                "http_method": "DELETE",
        ...
        self._export_parameter_template_from_cluster_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/parameterTemplate",
                "http_method": "POST",
    ...
    def list_parameter_templates(
        ...
        *,
        ...
        :param partition: the template partition in listParameterTemplates request
