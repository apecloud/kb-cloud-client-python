...
class ContainerInfo:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ContainerInfo":
        ...
        return cls(
            ...
            liveness_probe=data.get("livenessProbe"),
            readiness_probe=data.get("readinessProbe"),
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.ready is not None:
            _v = self.ready
            result["ready"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
        if self.restart_count is not None:
            _v = self.restart_count
            result["restartCount"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
        if self.liveness_probe is not None:
            _v = self.liveness_probe
            result["livenessProbe"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
        if self.readiness_probe is not None:
            _v = self.readiness_probe
            result["readinessProbe"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
