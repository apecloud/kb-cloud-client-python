...
class KafkaApi:
    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._create_kafka_topic_endpoint = _Endpoint(
            settings={
                "response_type": Topic,
                "endpoint_path": "/api/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topics",
                "http_method": "POST",
        ...
        self._delete_kafka_consumer_group_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/consumer-groups/{groupId}",
                "http_method": "DELETE",
        ...
        self._delete_kafka_topic_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/api/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topic/{topic}",
                "http_method": "DELETE",
        ...
        self._expand_kafka_topic_partitions_endpoint = _Endpoint(
            settings={
                "response_type": APIErrorResponse,
                "endpoint_path": "/api/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topic/{topic}/partitions",
                "http_method": "POST",
        ...
        self._get_kafka_broker_configs_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/brokers/{brokerId}/configs",
                "http_method": "GET",
        ...
        self._get_kafka_brokers_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/brokers",
                "http_method": "GET",
        ...
        self._get_kafka_topic_brokers_endpoint = _Endpoint(
            settings={
                "response_type": List[Broker],
                "endpoint_path": "/api/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topic/{topic}/brokers",
                "http_method": "GET",
        ...
        self._get_kafka_topic_config_endpoint = _Endpoint(
            settings={
                "response_type": List[ConfigEntry],
                "endpoint_path": "/api/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topic/{topic}/configs",
                "http_method": "GET",
        ...
        self._list_kafka_consumer_groups_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/consumer-groups",
                "http_method": "GET",
        ...
        self._list_kafka_topic_consumer_groups_endpoint = _Endpoint(
            settings={
                "response_type": List[ConsumerGroup],
                "endpoint_path": "/api/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topic/{topic}/consumer-groups",
                "http_method": "GET",
        ...
        self._list_kafka_topic_consumer_offsets_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topic/{topic}/consumer-groups/{groupId}/offsets",
                "http_method": "GET",
        ...
        self._list_kafka_topic_messages_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topic/{topic}/messages",
                "http_method": "GET",
