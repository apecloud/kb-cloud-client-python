    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._get_tenant_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/tenant/{tenantId}",
                "http_method": "GET",
        ...
        self._list_tenants_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/organizations/{orgName}/clusters/{clusterName}/tenants",
                "http_method": "GET",
