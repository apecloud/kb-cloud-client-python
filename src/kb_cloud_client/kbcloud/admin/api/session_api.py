    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._kill_session_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/data/{engineName}/organizations/{orgName}/clusters/{clusterName}/sessions/{session}",
                "http_method": "DELETE",
        ...
        self._list_sessions_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/admin/v1/data/{engineName}/organizations/{orgName}/clusters/{clusterName}/sessions",
                "http_method": "GET",
