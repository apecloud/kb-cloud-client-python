...
class PlatformParameter:
    ...
    id_: str
    name: str
    category: PlatformParameterCategory
    type_: str
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "PlatformParameter":
        ...
        return cls(
            id_=data.get("id"),
            name=data.get("name"),
            category=PlatformParameterCategory.from_dict(data.get("category")) if isinstance(data.get("category"), dict) else data.get("category"),
            type_=data.get("type"),
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.constraints is not None:
            _v = self.constraints
            result["constraints"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
