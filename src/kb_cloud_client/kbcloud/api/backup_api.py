...
class BackupApi:
    ...
    def __init__(self, api_client: Optional[ApiClient] = None):
        ...
        self._create_cluster_backup_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/clusters/{clusterName}/backups",
                "http_method": "POST",
        ...
        self._delete_backup_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/backups/{backupId}",
                "http_method": "DELETE",
        ...
        self._download_backup_endpoint = _Endpoint(
            settings={
                "response_type": bytes,
                "endpoint_path": "/api/v1/organizations/{orgName}/backups/{backupId}/download",
                "http_method": "GET",
        ...
        self._get_backup_log_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/backups/{backupId}/logs",
                "http_method": "GET",
        ...
        self._get_backup_stats_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/backupStats",
                "http_method": "GET",
        ...
        self._get_cluster_backup_policy_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/clusters/{clusterName}/backupPolicy",
                "http_method": "GET",
        ...
        self._list_backups_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/backups",
                "http_method": "GET",
        ...
        self._view_backup_endpoint = _Endpoint(
            settings={
                ...
                "endpoint_path": "/api/v1/organizations/{orgName}/backups/{backupId}/view",
                "http_method": "POST",
    ...
    def list_backups(
        ...
        *,
        ...
        :param with_h_scale: defined whether to search for hScale instance.
