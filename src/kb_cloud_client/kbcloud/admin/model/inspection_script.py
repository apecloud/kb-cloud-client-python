...
class InspectionScript:
    ...
    engine: str
    type_: str
    category: InspectionScriptCategory
    script_expr: str
    scope_type: str
    enabled: bool
    # Optional fields
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "InspectionScript":
        ...
        return cls(
            ...
            type_=data.get("type"),
            category=InspectionScriptCategory.from_dict(data.get("category")) if isinstance(data.get("category"), dict) else data.get("category"),
            ...
            script_expr=data.get("scriptExpr"),
            check_expr=data.get("checkExpr"),
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.script_expr is not None:
            _v = self.script_expr
            result["scriptExpr"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
        if self.check_expr is not None:
            _v = self.check_expr
            result["checkExpr"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
        if self.scope_type is not None:
            _v = self.scope_type
            result["scopeType"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
        if self.scope_id is not None:
            _v = self.scope_id
            result["scopeID"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
        if self.scope_name is not None:
            _v = self.scope_name
            result["scopeName"] = _v.to_dict() if hasattr(_v, "to_dict") else (
                [i.to_dict() if hasattr(i, "to_dict") else i for i in _v] if isinstance(_v, list) else _v
            )
