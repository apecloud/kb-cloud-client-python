...
@dataclass
class DisasterRecoveryCreate:
    """DisasterRecoveryCreate is the description to create a DisasterRecovery cluster"""
    # Required fields
    cluster: ClusterCreate
    # Optional fields

    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "DisasterRecoveryCreate":
